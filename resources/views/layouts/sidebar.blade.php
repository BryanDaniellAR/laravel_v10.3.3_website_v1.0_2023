<div class="container" style="padding-left: 0px; margin_bottom:15px;">
    <div class="container" style="justify-content: center;align-items: center;display: flex;">
        <img src="{{URL::asset('img/bryan.png')}}" style="width: 150px; height:150px;border-radius: 50%; margin-bottom: 30px;" title="logo_blanco">
    </div>
</div>
<ul class="sidebar-list">
    ...
    <li class="list {{'hosts'==Request::is('hosts*')?'active':''}}">
    ...
    <li class="list {{'roles'==Request::is('roles*')?'active':''}}">
    ...
    <li class="list {{'users'==Request::is('users*')?'active':''}}">
    ...
    <li class="list {{'profiles'==Request::is('profiles*')?'active':''}}">
    ...
    <li class="list {{'userhosts'==Request::is('userhosts*')?'active':''}}">
        <a href="{{route('userhosts.index')}}">
            <span>
    ...
    <li class="list {{'usabilities'==Request::is('usabilities*')?'active':''}}">
        <a href="{{route('usabilities.index')}}">
            <span>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-bezier2" viewBox="0 0 16 16">
    ...
    <li class="list {{'files'==Request::is('files*')?'active':''}}">
        <a href="{{route('files.index')}}">
            <span>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-file-earmark-post-fill" viewBox="0 0 16 16">
    ...
    <li class="list {{'images'==Request::is('images*')?'active':''}}">
    ...
    <!--<li class="cerrar_sesion" class="{{'logout'==Request::is('logout*')?'active':''}}">
